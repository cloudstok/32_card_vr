...
import { AccountsResult, BetReqData, BetResult, BetsObject, CurrentLobbyData, FinalUserData, GameResult, PlayerDetail, SingleBetObject } from '../../interfaces';
...
export const settleBet = async (io: IOServer, result: GameResult, roomId: number): Promise<void> => {
    try {
